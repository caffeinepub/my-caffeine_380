import { c as createLucideIcon, r as reactExports, y as useComposedRefs, o as useControllableState, j as jsxRuntimeExports, p as createContextScope, s as Primitive, w as composeEventHandlers, z as useSize, h as cn, f as useActor, u as useCompanySettings, E as useDarkMode, b as ue, F as Moon, G as Sun, W as Wifi, a as Button, m as Shield, H as compressLogoDataUrl } from "./index-Bn6g6lYN.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-DLSHX_61.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogFooter } from "./dialog-MBQBQP8q.js";
import { L as Label, I as Input } from "./label-e0YfKx0M.js";
import { u as usePrevious } from "./index-CpqiWBgh.js";
import { T as Textarea } from "./textarea-CM0GaNRx.js";
import { s as samplePackages } from "./sampleData-CwGarZnV.js";
import { u as usePackages } from "./useQueries-DtZ0qWy_.js";
import { X, P as Pencil } from "./x-BplQleUi.js";
import { L as LoaderCircle } from "./loader-circle-HnZMvkbp.js";
import { P as Plus, T as Trash2 } from "./trash-2-CPnHIkyC.js";
import { E as EyeOff, a as Eye } from "./eye-B3iOpznT.js";
...
const Building = createLucideIcon("building", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Settings({
  ...
  const [orgInfoForm, setOrgInfoForm] = reactExports.useState({
    companyBrand: settings.companyBrand,
    resellerName: settings.resellerName,
    directorName: settings.directorName,
    technicianName: settings.technicianName
  });
  const [orgInfoErrors, setOrgInfoErrors] = reactExports.useState({
    companyBrand: "",
    resellerName: "",
    directorName: "",
    technicianName: ""
  });
  const [savingOrgInfo, setSavingOrgInfo] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  async function handleSaveOrgInfo() {
    ...
    ue.success("তথ্য সফলভাবে আপডেট হয়েছে।");
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "settings.page", children: [
      ...
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10", children: isDark ? /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-4 h-4 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "w-4 h-4 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold", children: "অ্যাপিয়ারেন্স" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "ডিসপ্লে থিম পরিবর্তন করুন" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium", children: "ডার্ক মোড" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "রাত্রিকালীন বা কম আলোর পরিবেশে ব্যবহারের জন্য" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserCog, { className: "w-4 h-4 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold", children: "প্রতিষ্ঠানের তথ্য পরিবর্তন" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "কোম্পানি, রেসেলার, পরিচালক ও টেকনিশিয়ানের নাম পরিবর্তন করুন" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: orgInfoErrors.companyBrand ? "border-destructive" : ""
                }
              ),
              orgInfoErrors.companyBrand && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: orgInfoErrors.companyBrand })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs font-medium", children: [
                "রেসেলার কোম্পানির নাম ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  placeholder: "নওশীন ব্রডব্যান্ড ইন্টারনেট",
                  className: orgInfoErrors.resellerName ? "border-destructive" : ""
                }
              ),
              orgInfoErrors.resellerName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: orgInfoErrors.resellerName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs font-medium", children: [
                "পরিচালকের নাম ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: orgInfoErrors.directorName ? "border-destructive" : ""
                }
              ),
              orgInfoErrors.directorName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: orgInfoErrors.directorName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs font-medium", children: [
                "টেকনিশিয়ানের নাম ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  className: orgInfoErrors.technicianName ? "border-destructive" : ""
                }
              ),
              orgInfoErrors.technicianName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: orgInfoErrors.technicianName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  savingOrgInfo && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }),
                  "সংরক্ষণ করুন"
                ]
              }
            ) })
