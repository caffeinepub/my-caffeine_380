import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, s as Primitive, h as cn, u as useCompanySettings, X as Share2, a as Button, Y as RefreshCw, B as Badge, b as ue } from "./index-DlwMr6e1.js";
...
import { T as Trash2, P as Plus } from "./trash-2-Z7kVG5L4.js";
...
function SocialMediaPost({ isAdmin }) {
  ...
  async function generatePoster() {
    ...
    ctx.fillText("প্রয়োজনে যোগাযোগ করুন - WhatsApp no +8801648388329", 600, 1103);
    ctx.globalAlpha = 1;
    ...
    ctx.textBaseline = "middle";
    ctx.fillText(
      "পরিচালনায়: মুহাম্মদ মনিরুজ্জামান, সার্বিক তত্ত্বাবধানে মুহাম্মদ উজ্জল মিয়া।",
      600,
      1140
    );
