import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, p as Primitive, f as cn, u as useCompanySettings, a5 as Share2, a as Button, B as Badge, b as ue } from "./index-Ds0Kkum2.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-PLCC5eN2.js";
import { L as Label, I as Input } from "./label-XEvqS2qZ.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-D-L-QRp4.js";
import { T as Textarea } from "./textarea-DP9rcA27.js";
import { T as Trash2, P as Plus } from "./trash-2-DoxJtxmx.js";
import { D as Download } from "./download-BhSkRbg_.js";
import "./index-W2m97FC0.js";
/**
...
function SocialMediaPost({ isAdmin }) {
  ...
  async function generatePoster() {
    ...
    if (settings.whatsapp) {
      ...
      ctx.fillText(`WhatsApp: ${settings.whatsapp}`, 600, 1148);
    }
  ...
  if (!isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-[60vh] gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-foreground", children: "সোশ্যাল মিডিয়া পোস্টার তৈরি করতে এডমিন হিসেবে লগইন করুন" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "শুধুমাত্র এডমিনরা পোস্টার জেনারেট করতে পারবেন।" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, className: "hidden" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { size: 22, className: "text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-foreground", children: "সোশ্যাল মিডিয়া পোস্টার" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              customCategories.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "এখনো কোনো কাস্টম ক্যাটাগরি নেই"
                }
              ),
