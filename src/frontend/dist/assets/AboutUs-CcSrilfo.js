import { c as createLucideIcon, j as jsxRuntimeExports, U as Users, P as Phone } from "./index-Ds0Kkum2.js";
...
function AboutUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "aboutus.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-card border-border", "data-ocid": "aboutus.org.card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold text-foreground", children: "নওশীন ব্রডব্যান্ড ইন্টারনেট" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Delta Software & Communication Limited এর একটি রিসেলার" })
      ] })
    ] }) }) }),
