import { c as createLucideIcon, r as reactExports, u as useCompanySettings, j as jsxRuntimeExports, C as CreditCard, a as Button, D as Download, k as Bell, U as Users, b as ue } from "./index-C7L7qdp1.js";
...
import { M as MessageCircle } from "./message-circle-CFBP2mCr.js";
import { P as Pencil, X } from "./x-B1c2eMg0.js";
...
async function drawFrontCard(ctx, scale, data, offsetX = 0, offsetY = 0) {
  ...
  const footerText = (data == null ? void 0 : data.companyBrand) || "স্বাধীন ওয়াইফাই";
...
async function drawBackCard(ctx, scale, offsetX = 0, offsetY = 0, data) {
  const W = Math.round(CARD_WIDTH * scale);
  const H = Math.round(CARD_HEIGHT * scale);
  ctx.save();
  ctx.imageSmoothingEnabled = true;
  ...
  const segments = [
    ...
    {
      text: ` একাউন্ট থেকে Pay Bill অপশনে গিয়ে ${(data == null ? void 0 : data.companyBrand) || "স্বাধীন ওয়াইফাই"} খুঁজে বের করে সিআইডি নম্বর এবং মোবাইল নাম্বার ব্যবহার করে আপনার নির্ধারিত প্যাকেজ অনুযায়ী রিচার্জ করুন।`,
      color: "#1a2a4a",
      bold: false
    }
  ];
          ...
          isGenerated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: cardRef, className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-muted/30 px-4 py-3 text-xs text-muted-foreground space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                ...
                " ",
                settings.directorName || "আবুল কাশেম",
                " | WhatsApp: +8801607930157"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#ffffff", fontSize: "8px", margin: 0 }, children: companyBrand })
          }
        )
      ]
    }
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  ...
                  " অপশনে গিয়ে",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: companyBrand }),
                  " খুঁজে বের করে সিআইডি নম্বর এবং মোবাইল নাম্বার ব্যবহার করে আপনার নির্ধারিত প্যাকেজ অনুযায়ী রিচার্জ করুন।"
                ]
              }
            )
          }
...
function PrintCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(NIDCardBack, { companyBrand });
}
export {
  IdCard as default
};
