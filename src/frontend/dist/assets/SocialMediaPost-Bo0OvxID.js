import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, s as Primitive, h as cn, u as useCompanySettings, Y as Share2, a as Button, Z as RefreshCw, B as Badge, D as Download, b as ue } from "./index-C7L7qdp1.js";
...
import { T as Trash2, P as Plus } from "./trash-2-4d6TxwF7.js";
...
function SocialMediaPost({ isAdmin }) {
  ...
  async function generatePoster() {
    ...
    ctx.textBaseline = "middle";
    ctx.fillText(
      `পরিচালনায়: ${settings.directorName || "আবুল কাশেম"}, সার্বিক তত্ত্বাবধানে ${settings.technicianName || "মুহাম্মদ উজ্জল মিয়া"}।`,
      600,
      1140
    );
